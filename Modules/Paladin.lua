...
--==================================================
  ...
  local cooldowns = {
      AD_ID     = {id = 31850,  ready = false, reason = "", remaining = 0, name = "Ardent Defender",               info = "Defensive cooldown with cheat death"},
      GOTAK_ID  = {id = 86659,  ready = false, reason = "", remaining = 0, name = "Guardian of the Ancient Kings", info = "Defensive cooldown"},
      MOG_ID    = {id = 327193, ready = false, reason = "", remaining = 0, name = "Moment of Glory",               info = "Defensive cooldown"},
      BUBBLE_ID = {id = 642,    ready = false, reason = "", remaining = 0, name = "Divine Shield",                 info = "Immune/Cleanse"},
      BOS_ID    = {id = 204018, ready = false, reason = "", remaining = 0, name = "Blessing of Spellwarding",      info = "Magic damage immune"},
      EOT_ID    = {id = 387174, ready = false, reason = "", remaining = 0, name = "Eye of Tyr",                    info = "AOE incoming damage reduction"},
      HBW_ID    = {id = 432459, ready = false, reason = "", remaining = 0, name = "Holy Bulwark",                  info = "Hero Talent"},
      LOH_ID    = {id = 633,    ready = false, reason = "", remaining = 0, name = "Lay on Hands",                  info = "Big 100% heal"},
      AW_ID     = {id = 31884,  ready = false, reason = "", remaining = 0, name = "Avenging Wrath",                info = "Offensive cooldown with incoming damage reduction"},
      ST_ID     = {id = 389539, ready = false, reason = "", remaining = 0, name = "Sentinel",                      info = "Offensive Cooldown with incoming damage reduction"},
  }
  ...
  local buffs = {
      SOTR_ID         = {id = 132403, ready = 0, reason = "", remaining = 0, name = "Shield of the Righteous", info = "Active Mitigation"},
      CONSECRATION_ID = {id = 188370, ready = 0, reason = "", remaining = 0, name = "Consecration",            info = "Active Mitigation"},
      DEVOTION_ID     = {id = 465,    ready = 0, reason = "", remaining = 0, name = "Devotion Aura",           info = "Passive Damage Reduction"},
  }

  local dBuffs = {
      FORB_ID = {id = 25771, ready = 0, reason = "", remaining = 0, name = "Forbearance", info = "Paladin Debuff"},
  }
