...
--==================================================
   ...
   local cooldowns = {
      SW_ID     = {id = 871,    ready = false, reason = "", remaining = 0, name = "Shield Wall",          info = "Defensive cooldown"},
      LS_ID     = {id = 12975,  ready = false, reason = "", remaining = 0, name = "Last Stand",           info = "Defensive cooldown and temporary max HP increase"},
      SB_ID     = {id = 2565,   ready = false, reason = "", remaining = 0, name = "Shield Block",         info = "Defensive cooldown"},
      DS_ID     = {id = 1160,   ready = false, reason = "", remaining = 0, name = "Demoralizing Shout",   info = "AOE physical damage received reduction, also reduces damage output"},
      SR_ID     = {id = 23920,  ready = false, reason = "", remaining = 0, name = "Spell Reflect",        info = "Reflects spell back to caster"},
      IV_ID     = {id = 202168, ready = false, reason = "", remaining = 0, name = "Impending Victory",    info = "Heal and AP boost"},
      RC_ID     = {id = 97462,  ready = false, reason = "", remaining = 0, name = "Rallying Cry",         info = "Temporary max HP increase for you and party; survival buffer"},
      AVA_ID    = {id = 107574, ready = false, reason = "", remaining = 0, name = "Avatar",               info = "Significant damage increase and rage generation, extra rage for ignore pain"},
      SPB_ID    = {id = 392966, ready = false, reason = "", remaining = 0, name = "Spell Block",          info = "Heal and AP boost"},
    }
